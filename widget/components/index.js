...
function _buildApp(props, customMsgComponents = {}) {
    const app = createApp(Widget, { ...props }).use(_createPinia()).use(_createI18n());
    for (const [name, component] of Object.entries(customMsgComponents)) {
...
class ChatfaqWidget {
    constructor({
        ...
        props["customMsgComponents"] = customMsgComponents;
        ...
        this.app = _buildApp(props, customMsgComponents);
    }
