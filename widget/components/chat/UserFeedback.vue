        ...
        <div class="feedback-top">
            ...
            <div class="feedback-controls">
                ...
                <div class="control" :class="{'dark-mode': store.darkMode}">
                    <svg @click="copy" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M6.66669 4L6.66669 2.66667C6.66669 2.29848 6.96516 2 7.33335 2L11.0572 2C11.234 2 11.4036 2.07024 11.5286 2.19526L13.8048 4.4714C13.9298 4.59643 14 4.766 14 4.94281V11.3333C14 11.7015 13.7015 12 13.3334 12L9.33335 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <path d="M14 5.33333L11.3334 5.33333C10.9652 5.33333 10.6667 5.03486 10.6667 4.66667L10.6667 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>
            </div>
        </div>
