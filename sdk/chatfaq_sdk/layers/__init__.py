...
class StructuredGeneration(Layer):
    """
    Layers that uses a LLM for structured generation
    """

    _type = "llm_generated_text"  # This should be changed to llm_generated_text, but the widget is not ready for this change yet
