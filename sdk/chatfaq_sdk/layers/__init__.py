...
class LLMGeneratedText(Layer):
    ...
    _type = "rag_generated_text" # This should be changed to llm_generated_text, but the widget is not ready for this change yet

    def __init__(self, llm_config_name, messages: List[Dict[str, str]] = None, temperature: float = 0.7, max_tokens: int = 1024, seed: int = 42, *args, **kwargs):
        super().__init__(*args, **kwargs)
