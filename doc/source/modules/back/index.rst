...
Additionally, an admin user will be established with the credentials of "email=admin@admin.com", "user=admin" and "password=admin", as specified in the same file."
