...
- :ref:`The SDK <SDK's documentation>` serves two primary functions: it allows for the posting of new FSM definitions to the ChatFAQ's Back-end server, and it also launches an Remote Procedure Call (RPC) server to execute transitions and events from the posted FSM definitions.
